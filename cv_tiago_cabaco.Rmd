...
- <i class="fa fa-github"></i> [github.com/tijoalca](https://github.com/tiagocabaco)
...
- Familiar with <span style="text-decoration:underline; text-decoration-color: #3491b4">Python</span>
...
- Responsible for maintaining and developing R packages, used daily in production to process data from millions of users and to calculate around 10.000 daily survey results, which serve as the basis for our products. 
