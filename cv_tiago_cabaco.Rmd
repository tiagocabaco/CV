...
- Skilled in <span style="text-decoration:underline; text-decoration-color: #3491b4">Bash</span> (Linux command line)

- Familiar with <span style="text-decoration:underline; text-decoration-color: #3491b4">Python</span> and <span style="text-decoration:underline; text-decoration-color: #3491b4">C++</span>
...
- <span style="text-decoration:underline; text-decoration-color: #3491b4">R Markdown reports</span> (dynamic documentation with R)
...
- Worked with large data (millions of observations), using R tidyverse tools to program and test automated quality checking and data manipulation routines.  
- Use probabilistic programming language Stan to flexibly build complex Bayesian computational models.
...
- Created, maintained and fact-checked an archival data base with historical events from the Psychometric Society, resulting in a publication. 
- Used R to develop and deploy animated network visualizations of sequences of historical events. 
...
- Developed my communication and organizational skills, by being responsible for costumer care and for organizing the reading space and storage repositories.
...
- As student body representative, I made the bridge between the students and faculty. 
