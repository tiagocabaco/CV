...
- Skilled in Python, Bash, Stan and SQL.
...
- English (Fluent)
- Portuguese (Native)
- German (A1, studying at the A2.1 level)
...
I am currently looking for entry-level IT helpdesk and support-like roles. 
...
### Student - CompTIA A+ Certification

[CompTIA A+](https://www.comptia.org/certifications/a#overview)

Berlin, DE 

Today - February 2024

- Learning basic and essential IT concepts.
- Topics include:
    - Hardware;
    - Mobile devices;
    - Networking;
...
- Planning to finish Core 1 and Core 2 exams by September 2024. 
...
from other teams. 
- Provided support on issues related software and statistical products.  
...
- Contributed to the development of statistical libraries for survey data analysis using R and SQL. 
...
- Talked with potential customers on the phone to sell or extend their cable products. 
