...
- Developed R statistical libraries used daily to transform millions of user's poll 
answers into statistically representative results, used on all the company's costumer-facing products. 
